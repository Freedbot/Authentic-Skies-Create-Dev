...
import {$BufferBuilderAccessor, $BufferBuilderAccessor$Type} from "packages/top/leonx/irisflw/accessors/$BufferBuilderAccessor"
import {$VertexFormat$Mode, $VertexFormat$Mode$Type} from "packages/com/mojang/blaze3d/vertex/$VertexFormat$Mode"
...
public "localvar$bha000$vertex"(alpha: float): float
...
public "setIsFlyWheelBufferBuilder"(isFlyWheel: boolean): void
...
set "isFlyWheelBufferBuilder"(value: boolean)
