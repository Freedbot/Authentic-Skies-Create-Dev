...
declare module "packages/moe/wolfgirl/probejs/generated/schema/farmersdelight/Cutting" {
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
import {$RecipeJS, $RecipeJS$Type} from "packages/dev/latvian/mods/kubejs/recipe/$RecipeJS"
import {$OutputItem, $OutputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$OutputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Cutting extends $RecipeJS {


public "ingredients"(ingredients: ($InputItem$Type)[]): this
public "tool"(tool: $InputItem$Type): this
public "result"(result: ($OutputItem$Type)[]): this
...
import {Cooking, Cooking$Type} from "packages/moe/wolfgirl/probejs/generated/schema/farmersdelight/Cooking"
...
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {Cutting as Cutting$0, Cutting$Type as Cutting$0$Type} from "packages/moe/wolfgirl/probejs/generated/schema/farmersdelight/Cutting"
...
export class DocumentedRecipes {
 "farmersdelight": {cutting(ingredients: ($InputItem$Type)[], tool: $InputItem$Type, result: ($OutputItem$Type)[], sound?: string): Cutting$0, cooking(ingredients: ($InputItem$Type)[], result: $OutputItem$Type, experience: number, cookingtime: (number) | (string), container?: $InputItem$Type): Cooking}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/farmersdelight/Cooking" {
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
import {$RecipeJS, $RecipeJS$Type} from "packages/dev/latvian/mods/kubejs/recipe/$RecipeJS"
import {$OutputItem, $OutputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$OutputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Cooking extends $RecipeJS {
...
public "cookingtime"(cookingtime: (number) | (string)): this
public "container"(container: $InputItem$Type): this
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type Cooking$Type = (Cooking);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Cooking_ = Cooking$Type;
}}
