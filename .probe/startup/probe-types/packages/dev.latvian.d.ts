...
(filter: $ItemStack$Type, info: $FilterInfo$Type, expanded: boolean): void
}
...
public "handler$dkp000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
