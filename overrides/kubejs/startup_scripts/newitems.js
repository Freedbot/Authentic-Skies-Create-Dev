StartupEvents.registry('item', event => {
  ...
  event.create('create:reinforced_sheet') //for crafting reinforced deepslate
  ...
  event.create('occultism:ritual_possess_wandering_trader').displayName('Ritual: Summon Wandering Trader')
